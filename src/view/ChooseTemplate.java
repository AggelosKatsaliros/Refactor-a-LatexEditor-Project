	...
	private void initialize() {
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(book.isSelected()) {
					MainWindow mainWindow = new MainWindow("bookTemplate");
					
				}
				else if(report.isSelected()) {
					MainWindow mainWindow = new MainWindow("reportTemplate");
					
				}
				else if(article.isSelected()) {
					MainWindow mainWindow = new MainWindow("articleTemplate");
					
				}
				else if(letter.isSelected()) {
					MainWindow mainWindow = new MainWindow("letterTemplate");
				
				}
				else {
					MainWindow mainWindow = new MainWindow("emptyTemplate");
